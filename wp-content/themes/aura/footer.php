<footer class="footer__blocks ">
        <section class="container">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <div class="body mt-2 mt-md-10">
                                    ...
                                    <div class="mb-4"><a target="_blank" href="#">FAQs</a></div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3">
                ...
                <div class="col-12 col-lg-4 footer__cta order-3 pb-10 pb-lg-0 flex-xl-shrink-0 flex-xl-grow-1">
                    <div class="footer__cta-contain">
                        <div class="sub-text text-gradient">Never miss an opportunity!</div>
                        <div class="small-text mt-2 mt-md-10 -max-width-256">
                            Sign up now for exclusive events, feature release, announcement, plus few surprises!
                        </div>
                        <div class="mt-6 -max-width-256">
    ...
    <section class="bottom-bar pt-lg-6 pb-lg-5 pt-10 pb-9">
        <div class="container">
            <div class="row">
                <div class="caption-2 mt-10 mt-lg-0">Copyright © 2022 Aura Network. All rights reserved</div>
                <div class="d-flex">
                    <a href="https://discord.com/channels/925227249408557086/925227249408557089" target="_blank">
                        <i class="icon icon--switch-stage icon-discord"></i>
                    </a>
                    <a href="https://twitter.com/AuraNetworkHQ" target="_blank">
                        <i class="icon icon--switch-stage icon-twitter"></i>
                    </a>
                    <a href="https://t.me/auranw" target="_blank">
                    ...
                    <a href="https://www.linkedin.com/company/auranetwork/about/" target="_blank">
                        <i class="icon icon--switch-stage icon-linkedIn"></i>
                    </a>
                </div>
            </div>
        </div>
